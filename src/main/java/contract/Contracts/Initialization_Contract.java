...
public class Initialization_Contract {
    ...
    public  static String InitialzationUser(String[] s){
        System.out.println("did enter init user");
        if(userDone){
            return null;
        }
        ...
        userDone=true;
        System.out.println("will exit init user");
        return null;
    }
    ...
    public static String InitialzationRes(String[] s){
        ...
        resources.add(r6);
        resources.add(r7);
        Tool.writeResourceDB(resources);
        resDone=true;
        return null;
    }
    ...
    public static String InitialzationEquip(String[] s){
        ...
        for(int i=0;i<Tool.maxClientCount;i++){
            equips.add(new Equip("10.0.0."+i, "1", "1"));
        }
        Tool.writeEquipDB(equips);
        equipDone=true;
        return null;
    }
